...
- **Data Access & Querying:** Understanding of raw ADO.NET components, the Micro-ORM [Dapper](../../Concepts/Database/Dapper%20Basics.md), and the full ORM [Entity Framework Core](../../Concepts/Database/Entity%20Framework%20Core.md). Also learned to query collections using [LINQ Basics](../../Concepts/C%23/LINQ%20Basics.md) (`Where`, `Sum`). Mastered [Database Design Best Practices](../../Concepts/Database/Database%20Design%20Best%20Practices.md) and how to handle concurrent [Race Conditions](../../Concepts/Database/Race%20Conditions%20and%20Locking.md).
...
- **Introduced:** Delegates, ASP.NET Core MVC, Performance Tuning, System Design (HLD), HTTP APIs
...
graph TD
    ...
    E --> E4[Race Conditions & Locking]
    E --> E5[DB Design Practices]
